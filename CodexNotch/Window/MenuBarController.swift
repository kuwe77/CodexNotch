...
final class MenuBarController: NSObject {
    ...
    private func setupStatusItemAndPopover() {
        ...
        if let button = statusItem?.button {
            if AppModeConfig.current == .codexNotch {
                button.image = NSImage(systemSymbolName: "waveform.path.ecg", accessibilityDescription: "CodexNotch")
            } else {
                button.image = NSImage(systemSymbolName: "hammer.fill", accessibilityDescription: "CodexNotch")
            }
    ...
    private func updateIcon(for state: TelemetryState) {
        ...
        button.image = NSImage(systemSymbolName: symbolName, accessibilityDescription: "CodexNotch")?
