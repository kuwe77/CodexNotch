...
public struct CodexNotchSettingsView: View {
        ...
        Form {
            ...
            Section {
                ...
                HStack {
                    ...
                    Spacer()
                    TextField("Display name", text: $settings.preferredDisplayName)
                        .frame(width: 180)
                        .multilineTextAlignment(.trailing)
                }

                Text("Leave blank to prefer the built-in display, then fall back to the main screen.")
                    .font(.system(size: 11))
                    .foregroundColor(.secondary)
            } header: {
                Text("Display")
            ...
            Section {
                ...
                Toggle("Show 5h and 1w usage in notch", isOn: $settings.showCodexUsageInNotch)
                    .disabled(!settings.enableCodexJSONL)
